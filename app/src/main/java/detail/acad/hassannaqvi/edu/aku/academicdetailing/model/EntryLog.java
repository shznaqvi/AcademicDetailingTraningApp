...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.BR;
...
public class EntryLog extends BaseObservable implements Observable {
    ...
    public void populateMeta() {
        ...
        setUuid(MainApp.forms.getUID());  // not applicable in Form table
        setUserName(MainApp.user.getUserName());
        setSysDate(MainApp.forms.getFormDate());
