...
import static detail.acad.hassannaqvi.edu.aku.academicdetailing.core.UserAuth.generatePassword;
...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.core.UserAuth;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivityChangePasswordBinding;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.workers.UserWorker;
                        ...
                        public void onChanged(@Nullable WorkInfo workInfo) {
                            ...
                            if (workInfo.getState() != null &&
                                ...
                                try {
                                    ...
                                    bi.txtMessage.setTextColor(!error.equals("1") ? getResources().getColor(R.color.green) : getResources().getColor(R.color.darkRed));
                          ...
                          /*  StringBuilder sSyncedError = new StringBuilder();
                            ...
                            if (workInfo.getState() != null &&
                                ...
                                bi.txtMessage.setText(message);
                                bi.txtMessage.setVisibility(View.VISIBLE);
                                bi.txtMessage.setTextColor(getResources().getColor(R.color.darkRed));
