...
public class EcSbTest01 extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        if (type.equals("pre") && !isComplete) {
            ...
            GeneratorClass.comparingResult(bi.llecsbA, true, Data.correctAnswers);
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llecsbA, true, Data.correctAnswers);
            bi.btnOk.setVisibility(View.VISIBLE);
        ...
        if (formValidation()) {
            try {
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, EcSbTest01.class).putExtra("type", type));
                            isComplete = true;
    ...
    private void SaveDraft() {
        ...
        if (type.equals("pre")) {
            ...
            JSONObject json = GeneratorClass.getContainerJSON(bi.llecsbA, true, type);
            MainApp.fc.setPre_test(String.valueOf(json));
            Data.pretestAnswers = GeneratorClass.getAnswers(bi.llecsbA, true);
        } else {
            MainApp.fc.setPostTestEndTime(MainApp.getCurrentTime());
            JSONObject json = GeneratorClass.getContainerJSON(bi.llecsbA, true, type);
            MainApp.fc.setPost_test(String.valueOf(json));
            Data.posttestAnswers = GeneratorClass.getAnswers(bi.llecsbA, true);
        }
    ...
    private boolean formValidation() {
        ...
        return validatorClass.EmptyCheckingContainer(this, bi.llecsbA);
    }
