...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llecsbA, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
            ...
            MainApp.showDialog(EcSbTest01.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, EcSbTest01.class)
    ...
    private boolean formValidation() {
        return Validator.emptyCheckingContainer(this, bi.llecsbA);
