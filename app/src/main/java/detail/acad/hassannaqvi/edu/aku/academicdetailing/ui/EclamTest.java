...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivityEclamTestBinding;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.util.Data;

public class EclamTest extends AppCompatActivity {

    ActivityEclamTestBinding bi;
    Data.SubMenu subMenuDT;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this, R.layout.activity_eclam_test);
        bi.setCallback(this);
...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingResult(bi.llEclamTest, true, subMenuDT.getAnswers());
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llEclamTest, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
            ...
            MainApp.showDialog(EclamTest.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, EclamTest.class)
    ...
    private void SaveDraft() {
        ...
        if (type.equals("pre")) {
            ...
            JSONObject json = GeneratorClass.getContainerJSON(bi.llEclamTest, true, type);
            MainApp.forms.setPre_test(String.valueOf(json));
            Data.pretestAnswers = GeneratorClass.getAnswers(bi.llEclamTest, true);
        } else {

            MainApp.forms.setPostTestEndTime(MainApp.getCurrentTime());
            JSONObject json = GeneratorClass.getContainerJSON(bi.llEclamTest, true, type);
            MainApp.forms.setPost_test(String.valueOf(json));
            Data.posttestAnswers = GeneratorClass.getAnswers(bi.llEclamTest, true);
        }

    }

    private boolean formValidation() {
        return Validator.emptyCheckingContainer(this, bi.llEclamTest);
