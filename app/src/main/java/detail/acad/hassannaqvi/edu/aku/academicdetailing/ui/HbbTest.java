...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
        ...
        MainApp.showDialog(HbbTest.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, HbbTest.class)
    ...
    private void SaveDraft() {
        ...
        if (type.equals("pre")) {
            ...
            JSONObject json = GeneratorClass.getContainerJSON(bi.llHbbTest, true, type);
            MainApp.forms.setPre_test(String.valueOf(json));
            Data.pretestAnswers = GeneratorClass.getAnswers(bi.llHbbTest, true);
        } else {
            MainApp.forms.setPostTestEndTime(MainApp.getCurrentTime());
            JSONObject json = GeneratorClass.getContainerJSON(bi.llHbbTest, true, type);
            MainApp.forms.setPost_test(String.valueOf(json));
            Data.posttestAnswers = GeneratorClass.getAnswers(bi.llHbbTest, true);
        }
    ...
    private boolean formValidation() {
        ...
        return Validator.emptyCheckingContainer(this, bi.llHbbTest);
    }
