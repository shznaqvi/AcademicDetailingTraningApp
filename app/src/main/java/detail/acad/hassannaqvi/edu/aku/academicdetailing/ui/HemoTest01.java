...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivityHemoTest01Binding;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.util.Data;

public class HemoTest01 extends AppCompatActivity {

    ActivityHemoTest01Binding bi;
...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingResult(bi.llHemoTestA, true, subMenuDT.getAnswers());
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llHemoTestA, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
            ...
            MainApp.showDialog(HemoTest01.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, HemoTest01.class)
    ...
    private void SaveDraft() {
        ...
        if (type.equals("pre")) {
            ...
            JSONObject json = GeneratorClass.getContainerJSON(bi.llHemoTestA, true, type);
            MainApp.forms.setPre_test(String.valueOf(json));
            Data.pretestAnswers = GeneratorClass.getAnswers(bi.llHemoTestA, true);
        } else {

            MainApp.forms.setPostTestEndTime(MainApp.getCurrentTime());
            JSONObject json = GeneratorClass.getContainerJSON(bi.llHemoTestA, true, type);
            MainApp.forms.setPost_test(String.valueOf(json));
            Data.posttestAnswers = GeneratorClass.getAnswers(bi.llHemoTestA, true);
        }
    ...
    private boolean formValidation() {
        ...
        return Validator.emptyCheckingContainer(this, bi.llHemoTestA);
    }
