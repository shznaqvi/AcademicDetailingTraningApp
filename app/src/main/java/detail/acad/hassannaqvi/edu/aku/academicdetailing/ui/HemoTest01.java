...
public class HemoTest01 extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        if (type.equals("pre") && !isComplete) {
            ...
            GeneratorClass.comparingResult(bi.llHemoTestA, true, Data.correctAnswers);
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llHemoTestA, true, Data.correctAnswers);
            bi.btnOk.setVisibility(View.VISIBLE);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, HemoTest01.class).putExtra("type", type));
                            isComplete = true;
    ...
    private boolean formValidation() {
        ...
        return validatorClass.EmptyCheckingContainer(this, bi.llHemoTestA);
    }
