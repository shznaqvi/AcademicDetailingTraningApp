...
public class HemoTest02 extends AppCompatActivity {
    ...
    ActivityHemoTest02Binding bi;
    Data.SubMenu subMenuDT;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this, R.layout.activity_hemo_test02);
        bi.setCallback(this);
...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingResult(bi.llHemoTestB, true, subMenuDT.getAnswers());
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llHemoTestB, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
            ...
            MainApp.showDialog(HemoTest02.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, HemoTest02.class)
    ...
    private boolean formValidation() {
        ...
        return Validator.emptyCheckingContainer(this, bi.llHemoTestB);
    }
