...
public class HemoTest02 extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        if (type.equals("pre") && !isComplete) {
            ...
            GeneratorClass.comparingResult(bi.llHemoTestB, true, Data.correctAnswers);
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llHemoTestB, true, Data.correctAnswers);
            bi.btnOk.setVisibility(View.VISIBLE);
