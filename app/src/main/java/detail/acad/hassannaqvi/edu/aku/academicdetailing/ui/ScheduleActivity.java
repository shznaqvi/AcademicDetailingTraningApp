...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivityScheduleBinding;
...
public class ScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bi = DataBindingUtil.setContentView(this, R.layout.activity_schedule);
            ...
            public void onClick(View v) {
                if (formValidate()) {
                    ...
                    if (updateDB()) {
                        ...
                        Toast.makeText(ScheduleActivity.this, "Error in database", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    public boolean updateDB() {
        ...
        if (count != -1) {
            ...
            Toast.makeText(ScheduleActivity.this, "Error in updating DB", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void saveDraft() {
        ...
        MainApp.nmc.setFormdate(new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.ENGLISH).format(new Date().getTime()));
    ...
    public void setGPS() {
        SharedPreferences GPSPref = ScheduleActivity.this.getSharedPreferences("GPSCoordinates", Context.MODE_PRIVATE);
        ...
        try {
            ...
            if (lat.equals("0") && lang.equals("0")) {
                Toast.makeText(ScheduleActivity.this, "Could not obtained GPS points", Toast.LENGTH_SHORT).show();
            }
            ...
            Toast.makeText(ScheduleActivity.this, "GPS set", Toast.LENGTH_SHORT).show();
...
/*        if (!validatorClass.EmptyTextBox(getContext(), bi.bookDate, getString(R.string.book_date))) {
    ...
    private void populateSpinner() {
        ...
        bi.bookingType.setAdapter(new ArrayAdapter<>(ScheduleActivity.this, android.R.layout.simple_spinner_dropdown_item, bookingType));
        bi.sessions.setAdapter(new ArrayAdapter<>(ScheduleActivity.this, android.R.layout.simple_spinner_dropdown_item, sessions));
        modules.addAll(Arrays.asList(Data.modules));
        bi.modules.setAdapter(new ArrayAdapter<>(ScheduleActivity.this, android.R.layout.simple_spinner_dropdown_item, modules));
    ...
    private void selectModule(int position) {
        ...
        switch (position) {
            case 1:
                ...
                bi.subModules.setAdapter(new ArrayAdapter<>(ScheduleActivity.this, android.R.layout.simple_spinner_dropdown_item, subModules));
