...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivityShockTestBinding;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.util.Data;

public class ShockTest extends AppCompatActivity {

    ActivityShockTestBinding bi;
...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingResult(bi.llShockTest, true, subMenuDT.getAnswers());
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llShockTest, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
        ...
        MainApp.showDialog(ShockTest.this, "Do You Want To Exit?", "end", false, subMenuDT);
                ...
                if (UpdateDB()) {
                    if (type.equals("pre")) {
                        if (MainApp.isSlideStart) {
                            startActivity(new Intent(this, ShockTest.class)
    ...
    private void SaveDraft() {
        ...
        if (type.equals("pre")) {
            ...
            JSONObject json = GeneratorClass.getContainerJSON(bi.llShockTest, true, type);
            MainApp.forms.setPre_test(String.valueOf(json));
            Data.pretestAnswers = GeneratorClass.getAnswers(bi.llShockTest, true);
        } else {

            MainApp.forms.setPostTestEndTime(MainApp.getCurrentTime());
            JSONObject json = GeneratorClass.getContainerJSON(bi.llShockTest, true, type);
            MainApp.forms.setPost_test(String.valueOf(json));
            Data.posttestAnswers = GeneratorClass.getAnswers(bi.llShockTest, true);
        }
    ...
    private boolean formValidation() {
        ...
        return Validator.emptyCheckingContainer(this, bi.llShockTest);
    }
