...
public class ShockTest extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        if (type.equals("pre") && !isComplete) {
            ...
            GeneratorClass.comparingResult(bi.llShockTest, true, Data.correctAnswers);
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.llShockTest, true, Data.correctAnswers);
            bi.btnOk.setVisibility(View.VISIBLE);
            bi.btnContinue.setVisibility(View.GONE);
        }
