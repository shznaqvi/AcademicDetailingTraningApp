...
import static detail.acad.hassannaqvi.edu.aku.academicdetailing.core.MainApp.sdDir;
...
import detail.acad.hassannaqvi.edu.aku.academicdetailing.databinding.ActivitySyncBinding;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.model.SyncModel;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.workers.DataDownWorkerALL;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.workers.DataUpWorkerALL;
import detail.acad.hassannaqvi.edu.aku.academicdetailing.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                //Next Meeting
                uploadTables.add(new SyncModel(NextMeetingTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedNextMeetings());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(NextMeeting): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(NextMeeting)" + e.getMessage(), Toast.LENGTH_LONG).show();

                }
  //Next Meeting
                uploadTables.add(new SyncModel(SessionTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedSessions());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(Session): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(Session)" + e.getMessage(), Toast.LENGTH_LONG).show();
                ...
                try {
                    MainApp.uploadData.add(db.getUnsyncedEntryLogs());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(EntryLogs): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(EntryLogs)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }
