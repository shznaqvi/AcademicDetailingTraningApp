...
//            Data.correctAnswers = getIntent().getStringArrayListExtra("ans");
            ...
            GeneratorClass.comparingResult(bi.fldGrpVbPre, true, subMenuDT.getAnswers());
            ...
            GeneratorClass.comparingPostTestAndPretestResult(bi.fldGrpVbPre, true, subMenuDT.getAnswers());
...
//            MainApp.showDialog(this, getString(R.string.areYouSure), "end", true, subMenuDT);
    ...
    public void BtnEnd(View view) {
        MainApp.showDialog(VB_Pre_test.this, "Do You Want To Exit?", "end", false, subMenuDT);
    }
    ...
    private boolean formValidation() {
        ...
        return Validator.emptyCheckingContainer(this, bi.fldGrpVbPre);
    }
